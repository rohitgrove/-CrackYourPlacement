...
public class MaxValueOfEquation {
    public static int findMaxValueOfEquation(int[][] points, int k) {
        ...
        for (int i = 0; i < points.length; i++) {
            ...
            // and x in peeked index is greater than k then we dont need the peeked value in
            // deque
            ...
            // if the non checked values i.e. the difference of y - x of indexes at the end
            // of deque is smaller
            // than current y - x then we don't need those values as we already have the
            // greater value so
